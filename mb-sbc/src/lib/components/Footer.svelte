<div
			class="container mx-auto bg-primary-700 dark:bg-primary-900 text-surface-50 text-center"
		>
			<div class="grid md:grid-flow-col grid-cols-1 md:grid-cols-2 gap-0 pt-12 px-8 lg:px-16">
				<div class="grid grid-flow-col gap-2 justify-center md:justify-start">
					...
					<a href="https://saobernardo.maplebear.com.br" title="Maple Bear - SBC" target="_new">
						<img src="mb-sbc-tagline.webp" alt="Maple Bear - SBC" width="192" height="86" class="w-48 py-4">
					</a>
				</div>
				...
				>
					<div class="wh cursor-pointer hover:scale-95 transition-all duration-200">
						<a href="http://wa.me/5511971043428" title="WhatsApp - (11) 97104-3428" target="_new">
						<svg class="h-7 w-7 pt-1 mr-1 text-white" stroke-width="0" stroke="currentColor" fill="white" height="20" width="20" viewBox="0 0 308 308" xml:space="preserve">
						<g id="XMLID_468_">
					...
					<div class="email cursor-pointer hover:scale-95 transition-all duration-200">
						<a href="mailto:relacionamento@maplebearsbc.com" title="relacionamento@maplebearsbc.com" target="_new">
						<svg
					...
					<div class="fb cursor-pointer hover:scale-95 transition-all duration-200">
						<a href="https://www.facebook.com/maplebearsbc" title="@maplebearsbc" target="_new">
						<svg
							class="h-8 w-8 text-white"
							width="24"
							height="24"
